...
import Category from "@/components/common/CategoryFilter";
  ...
  return status >= 300 ? (
    ...
    <div className="min-h-screen allFitness">
      <div className="container mx-auto  p-4">
        ...
        <div className="gap-5 flex flex-col justify-center w-full lg:w-2/3 mx-auto">
          {status === 204 ? (
