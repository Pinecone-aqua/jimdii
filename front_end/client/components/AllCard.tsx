	...
	return (
		<Link href={`/fitness/${fitness._id}`}>
			<div className="w-full flex justify-center items-center mb-[20px] pt-[20px] flex-col md:flex-row text-white">
				<div className="w-full md:w-3/4 h-[200px] md:h-[300px] lg:h-[400px]">
					<picture>
						<img
							src={fitness.image[0]}
							alt="fitnesspic"
				...
				<div className="bg-black w-full md:w-2/5 border h-[140px] md:h-[240px] lg:h-[340px] flex flex-col justify-center items-center rounded-b-lg md:rounded-lg md:scale-x-125">
